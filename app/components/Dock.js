    ...
    return ( 
      <View style={styles.dock_container}>
        <View style={styles.dock}>
          ...
          {/* History */}
          <MaterialCommunityIcons name="history" size={24} color="#235789" onPress={() => this.props.navigation.navigate('HistoryScreen')} />
          {/* Profile */}
          <MaterialIcons name="person-outline" size={24} color="#235789" onPress={() => this.props.navigation.navigate('ProfileScreen')}/>
        </View>
      </View>
    )
  }
